...
describe('Service Tests', () => {
    describe('Bureau Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BureauService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bureaus';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Bureau', () => {
                service.create(new Bureau(null)).subscribe(received => {
            ...
            it('should update a Bureau', () => {
                service.update(new Bureau(123)).subscribe(received => {
