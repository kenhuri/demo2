    ...
    describe('Poste Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/postes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Poste', () => {
                service.create(new Poste(null)).subscribe(received => {
            ...
            it('should update a Poste', () => {
                service.update(new Poste(123)).subscribe(received => {
